...
This issue tracker is only for technical issues related to ADON Core.
General ADON questions and/or support requests and are best directed to the [ADON Discord](https://discord.adonis.network).
...
### What version of ADON Core are you using?
