...
By default, adond will dump mempool on shutdown and
...
class MempoolPersistTest(AdonTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent adond from writing mempool.dat to disk. Verify that `savemempool` fails")
