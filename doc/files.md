...
adon.conf           | contains configuration settings for adond or adon-qt
adond.pid           | stores the process id of adond while running
...
debug.log           | contains debug information and general logging generated by adond or adon-qt
