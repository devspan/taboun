...
with certain assembly code from ADON Core's code. See [developer notes on sanitizers](https://github.com/AdonisExchange/ADON/blob/master/doc/developer-notes.md#sanitizers)
